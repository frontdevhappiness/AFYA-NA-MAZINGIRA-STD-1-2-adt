...
├── AFYA-NA-MAZINGIRA-STD-1-2.db                    # SQLite database (pipeline state)
├── AFYA-NA-MAZINGIRA-STD-1-2.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im002": "Afya na Mazingira, Kitabu cha Mwanafunzi cha Darasa la Kwanza.",
  "gl001": "afya",
  "gl001_def": "Hali ya mwili kuwa mzima na bila ugonjwa.",
  "qz001_que": "Unatumia nini kusafisha meno?",
  "qz001_o0": "1) Kiatu",
  "qz001_o0_exp": "❌ Si sahihi. Kiatu huvaliwa miguuni, hakitumiki kusafisha meno."
}
```
...
```json
{
  "afya": {
    "word": "afya",
    "definition": "Hali ya mwili kuwa mzima na bila ugonjwa.",
    "variations": ["afya"],
    "emoji": "💪😊"
  }
}
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">Unatumia nini kusafisha meno?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="❌ Si sahihi. Kiatu huvaliwa miguuni, hakitumiki kusafisha meno." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) Kiatu</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `AFYA-NA-MAZINGIRA-STD-1-2.pdf` |
| Pipeline database | `AFYA-NA-MAZINGIRA-STD-1-2.db` (SQLite) |
